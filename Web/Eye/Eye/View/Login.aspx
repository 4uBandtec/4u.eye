        ...
        <form id="formLogin" runat="server">
            ...
            <div class="areaCampos">
                ...
                <div class="campos">
                    ...
                    <asp:TextBox ID="txtWorkspacename" runat="server" Placeholder="Me diga seu Workname ou E-mail"></asp:TextBox>

                    <asp:TextBox ID="txtSenha" runat="server" Placeholder="Qual a sua Senha?" type="password"></asp:TextBox>
