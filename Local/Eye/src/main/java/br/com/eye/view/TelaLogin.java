...
public class TelaLogin extends JFrame implements ActionListener{	
    ...
    JTextField txtWorkname = new JTextField(),
    ...
    public TelaLogin(){	
            ...
            txtWorkname.setFont(fontSergoe);
            txtWorkname.setBorder(borderRed);
            txtWorkname.setName("txtWorkname");
            txtWorkname.setForeground(txtColor);
            txtWorkname.setBackground(bgColor);
